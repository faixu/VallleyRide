        ...
        <div className="space-y-6">
          ...
          {loading ? (
            ...
            <div className="bg-white p-12 rounded-[32px] text-center border-2 border-dashed border-gray-100">
              ...
              <p className="text-gray-400 font-bold uppercase tracking-widest text-xs">No active drivers in this category</p>
              <p className="text-sm text-gray-500 mt-2">Try selecting another vehicle type</p>
            </div>
          ) : (
                ...
                {filteredDrivers.map((driver) => (
                  ...
                  >
                    <div className="relative">
                      <img src={driver.photoURL} alt={driver.displayName} className="w-24 h-24 rounded-2xl object-cover shadow-lg border-4 border-white" />
                    ...
                    <div className="flex-1 space-y-4 text-center md:text-left">
                      <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                        <h4 className="text-2xl font-black text-brand-green">{driver.displayName}</h4>
                      ...
                      <div className="grid grid-cols-2 md:flex md:gap-8 gap-4 py-2">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm font-bold text-gray-700">{driver.totalTrips} Trips</p>
                        </div>
                    ...
                    <div className="flex md:flex-col gap-3 w-full md:w-auto">
                      ...
                      <button 
                        ...
                        className="flex-1 md:w-32 py-3 bg-brand-gold text-brand-green rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:scale-105 active:scale-95 shadow-lg shadow-brand-gold/10 transition-all disabled:opacity-50"
                      >
                        {bookingInProgress ? <Loader2 className="animate-spin" size={16} /> : 'Book Now'}
                      </button>
                    </div>
                  </motion.div>
                ))}
